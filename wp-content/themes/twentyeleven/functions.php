...
/**
 * Customized login page logo by weiri 2012-08-25
 */
function custom_loginlogo() {
echo '<style type="text/css">
h1 a {background-image: url('.get_bloginfo('template_directory').'/images/login-logo.jpg)!important; background-size: 354px 168px!important; top center; width:354px!important; height:168px!important; }
</style>';
}
add_action('login_head', 'custom_loginlogo');
/**
 * Customized admin dashboard page logo by weiri 2012-08-25
 */  
...
function my_custom_logo() {
   ...
   #wp-admin-bar-wp-logo > .ab-item .ab-icon  
    { background-image: url('.get_bloginfo('template_directory').'/images/dashboard-logo.png)!important; }
   </style>';
}

/**
 * Customized login page logo link by weiri 2012-08-25
 */  
add_filter("login_headerurl", create_function(false,"return get_bloginfo('siteurl');"));
/**
 * Customized dashboard views by weiri 2012-09-02
 */ 
...
/**
 * Customized version number and copy right in footer of admin console by weiri 2012-09-02
 */ 
function change_footer_admin () {return 'Modify By Richard Wei';}
add_filter('admin_footer_text', 'change_footer_admin', 9999);
function change_footer_version() {return ' ';}
add_filter( 'update_footer', 'change_footer_version', 9999);
/**
 * Customized 你将删除站点上所有不同区域中的WordPress版本号码。这才是正确完整可行的方案。 by weiri 2012-09-02
